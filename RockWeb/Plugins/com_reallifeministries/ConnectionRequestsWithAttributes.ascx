<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ConnectionRequestsWithAttributes.ascx.cs" Inherits="com.reallifeministries.ConnectionRequestsWithAttributes" %>
