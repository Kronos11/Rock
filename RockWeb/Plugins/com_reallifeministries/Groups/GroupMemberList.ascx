<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupMemberList.ascx.cs" Inherits="com.reallifeministries.Groups.GroupMemberList" %>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="grid grid-panel">
                            <Rock:GridFilter ID="rFilter" runat="server" OnDisplayFilterValue="rFilter_DisplayFilterValue">
                                ...
                                <Rock:RockCheckBoxList ID="cblRole" runat="server" Label="Role" RepeatDirection="Horizontal" />                                <Rock:RockCheckBoxList ID="cblStatus" runat="server" Label="Status" RepeatDirection="Horizontal" />
                            ...
                            <Rock:Grid ID="gGroupMembers" runat="server" DisplayType="Full" AllowSorting="true" OnRowSelected="gGroupMembers_Edit" CssClass="js-grid-group-members" >
                                <Columns>
                                    ...
                                    <Rock:RockBoundField DataField="GroupName" HeaderText="Group" SortExpression="Group.Name" />
